...
function Home() {
    ...
    const handleSubmit = async ()=>{
        ...
        try {
            ...
            // 🔽 NEW: save this attempt to Supabase via /api/attempts
            // We only try if a task is actually selected.
            if (selectedTaskId) {
                try {
                    ...
                    // Non-blocking: scoring result still shows even if saving fails
...
//# sourceMappingURL=%5Broot-of-the-server%5D__de681f07._.js.map