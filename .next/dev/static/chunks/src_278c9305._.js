...
function SignupPage() {
    _s();
    const { supabase } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$SupabaseSessionProvider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSupabaseSession"])();
    ...
    const handleSignup = async ()=>{
        ...
        if (!data.session) {
            setInfo("Account created. Please check your email and click the confirmation link, then log in from the Login page.");
        } else {
...
_s(SignupPage, "odAamvR7wGmkX7SwxOF0mAFiGAw=", false, function() {
    return [
...
//# sourceMappingURL=src_278c9305._.js.map