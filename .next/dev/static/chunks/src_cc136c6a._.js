...
function EssayBox(t0) {
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(14);
    if ($[0] !== "3e9e2ec3424f8e987096d2a773764684eaddd008ab3b9cd86e86853a704a8d5e") {
        for(let $i = 0; $i < 14; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "3e9e2ec3424f8e987096d2a773764684eaddd008ab3b9cd86e86853a704a8d5e";
    }
    const { value, onChange } = t0;
    let t1;
    if ($[1] !== value) {
        t1 = value.trim() ? value.trim().split(/\s+/).length : 0;
        $[1] = value;
        $[2] = t1;
    } else {
        t1 = $[2];
...
function TaskFeed(t0) {
    ...
    if ($[0] !== "ae2ac14f57d719bad62fe62f192a0d3d28c893c03f5c3bea7b4f91d9c08d7e0e") {
        for(let $i = 0; $i < 19; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "ae2ac14f57d719bad62fe62f192a0d3d28c893c03f5c3bea7b4f91d9c08d7e0e";
    }
