...
function SignupPage() {
    ...
    const handleSignup = async ()=>{
        ...
        if (error) {
            ...
            // Supabase will send a confirmation email (from Supabase Auth sender for now)
            // After confirming, student can log in via /auth/login
...
_s(SignupPage, "X47czmIQCdO59bfnapNkbldXYI0=", false, function() {
    return [
